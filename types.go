...
func (elt *Element) Uint16(defaultValue ...uint16) (uint16, error) {
	...
	v, err := cast.ToUint16E(elt.Value)
	if err != nil {
		if def == nil {
			var v uint16
...
func (elt *Element) Uint32(defaultValue ...uint32) (uint32, error) {
	...
	v, err := cast.ToUint32E(elt.Value)
	if err != nil {
		if def == nil {
			var v uint32
...
func (elt *Element) Uint64(defaultValue ...uint64) (uint64, error) {
	...
	v, err := cast.ToUint64E(elt.Value)
	if err != nil {
		if def == nil {
			var v uint64
...
func (elt *Element) Float32(defaultValue ...float32) (float32, error) {
	...
	v, err := cast.ToFloat32E(elt.Value)
	if err != nil {
		if def == nil {
			var v float32
...
func (elt *Element) Float64(defaultValue ...float64) (float64, error) {
	...
	v, err := cast.ToFloat64E(elt.Value)
	if err != nil {
		if def == nil {
			var v float64
...
func (elt *Element) String(defaultValue ...string) (string, error) {
	...
	v, err := cast.ToStringE(elt.Value)
	if err != nil {
		if def == nil {
			var v string
